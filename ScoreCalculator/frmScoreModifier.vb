...
#End Region
    ...
    Private Sub frmScoreModifier_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        SetObjectEnableDisable_ThreadSafe(btnStop, False)
        txtFolderpath.Text = My.Settings.ScoreModifierFolder
        txtEmpFilename.Text = My.Settings.ScoreModifierEmpListFile
    End Sub
    ...
    Private Async Sub btnStart_Click(sender As Object, e As EventArgs) Handles btnStart.Click
        My.Settings.ScoreModifierFolder = txtFolderpath.Text
        My.Settings.ScoreModifierEmpListFile = txtEmpFilename.Text
        My.Settings.Save()
    ...
    Private Async Function StartProcessingAsync() As Task
        Try
            ...
            Dim directoryPath As String = GetTextBoxText_ThreadSafe(txtFolderpath)
            Dim empFile As String = GetTextBoxText_ThreadSafe(txtEmpFilename)

            Using scrMdfr As New ScoreModifier(_canceller, directoryPath, empFile)
