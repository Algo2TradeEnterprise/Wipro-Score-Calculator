...
#End Region
    ...
    Public Sub New(ByVal canceller As CancellationTokenSource, ByVal mappingFile As String, ByVal employeeFile As String, ByVal asgFile As String, ByVal emailEmpMap As List(Of EmployeeMapping))
        _cts = canceller
                                                                                    ...
                                                                                    For Each runningEmpID In runningEmpIDs
                                                                                        If runningEmpID IsNot Nothing Then
                                                                                            Dim asgDetails As List(Of ASG) = asgData.FindAll(Function(x)
                                                                                                                                                 Return x.EmpID = runningEmpID
                                                                                                                                             End Function)
                                                                                            If asgDetails IsNot Nothing AndAlso asgDetails.Count > 0 Then
